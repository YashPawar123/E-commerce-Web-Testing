...
public class AMZ_IT_07 {
	...
	public void addresspage() {
		...
		WebElement sin=driver.findElement(By.xpath("//span[.='Hello, yash']"));
		sin.click();
		
		WebElement address=driver.findElement(By.xpath("//span[.='Edit addresses for orders and gifts']"));
		address.click();
	}
} 
